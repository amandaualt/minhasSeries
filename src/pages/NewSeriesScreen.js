...
import { setField, saveSerie, setAllFieds, resetForm } from "../actions";
...
class NewSerieScreen extends React.Component {
  ...
  componentDidMount() {
    const { navigation, setAllFieds, resetForm } = this.props;
    const { params } = navigation.state;
    if (params && params.serieToEdit) {
      setAllFieds(params.serieToEdit);
    } else {
      resetForm();
    }
  }
  ...
  viewGallery() {
    this.requestExternallStorageAccess();
  ...
  async requestExternallStorageAccess() {
    try {
      ...
      <View style={styles.container}>
        <RNCamera
          ...
          androidCameraPermissionOptions={{
            ...
            message: "precisa permissao",
            buttonPositive: "Aceito",
            buttonNegative: "Cancelar",
          }}
          androidRecordAudioPermissionOptions={{
            title: "Permissao p gravar",
            message: "precisa permissao p gravar",
            buttonPositive: "Aceito",
            buttonNegative: "Cancelar",
          }}
        />
        ...
        <FormRow>
          ...
          <View style={{ paddingTop: 10 }}>
            <Button
              ...
              onPress={() => {
                Alert.alert("Captura de Image", "De onde quer pegar?", [
                  {
                    text: "Camera",
                    onPress: () => {
